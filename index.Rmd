...
Se puede complejizar, como todo

```{r}
ggplot(legos2) +
  geom_histogram(aes(Year, fill = Theme), binwidth = 1) +
...
## Variables Categóricas x 2

heatmap
treemap nested

## Variables Numéricas x 2
